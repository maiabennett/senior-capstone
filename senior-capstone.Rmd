...
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/seurat15-varfeatures.png")
plot1 + plot2
dev.off
...
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/seurat15-jackstraw.png")
...
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/seurat18-varfeatures.png")
plot3 + plot4
dev.off()
...
png(file = "~/graphics/seurat18-jackstraw.png")
...
plot2 <- LabelPoints(plot = plot1, points = top10, repel = TRUE)
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/seurat12int-varfeatures.png")
plot1 + plot2
dev.off()
...
png(file = "~/graphics/seurat12int-jackstraw.png")
...
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/12healthy-varfeatures.png")
plot5 + plot6
dev.off()
png(file = "C:/Users/Me/OneDrive - University of Nebraska at Omaha/Administrative/Documents/Senior Project/senior-capstone/graphics/seurat12UC-varfeatures.png")
plot7 + plot8
dev.off()
...
png(file = "~/graphics/seurat12-jackstraw.png")
...
png(file = "~/graphics/seurat15-initialUMAP.png")
...
png(file = "~/graphics/seurat15-initialmarkers.png")
...
png(file = "~/graphics/seurat15-labeledUMAP.png")
...
png(file = "~/graphics/seurat15-dotplot.png")
...
png(file = "~/graphics/seurat15ilc-initialUMAP.png")
...
png(file = "~/graphics/seurat15ilc-initialmarkers.png")
...
png(file = "~/graphics/seurat15ilc-labeledUMAP.png")
...
png(file = "~/graphics/seurat15ilc-dotplot.png")
...
png(file = "~/graphics/seurat18-initialUMAP.png")
...
png(file = "~/graphics/seurat18-labeledUMAP.png")
...
png(file = "~/graphics/seurat18immune-initialUMAP.png")
...
png(file = "~/graphics/seurat18immune-markers.png")
...
png(file = "~/graphics/seurat12int-initialUMAP.png")
...
### Bs: 
### Myeloids: 
png(file = "~/graphics/seurat12int-initialmarkers.png")
...
png(file = "~/graphics/seurat12int-labeledUMAP.png")
...
markers.to.plot <- c("")
png(file = "~/graphics/seurat12int-dotplot.png")
...
png(file = "~/graphics/seurat12intilc-initialUMAP.png")
...
### ILC3s: CD127/IL7R+, CD161/KLRB1+, CD117/KIT+, CD294/PTGDR-
### NKs: CD56/NCAM1+, EOMES+
png(file = "~/graphics/seurat12intilc-initialmarkers.png")
...
png(file = "~/graphics/seurat12intilc-labeledUMAP.png")
...
markers.to.plot <- c("NCAM1", "EOMES", "IL7R", "PTGDR2", "KIT", "KLRB1", "GATA3")
png(file = "~/graphics/seurat12intilc-dotplot.png")
...
png(file = "~/graphics/seurat12-initialUMAP.png")
...
### NKs: CD56/NCAM1+, EOMES+
### Ts: CD3/CD3D+ (definite)
png(file = "~/graphics/seurat12-initialmarkers.png")
...
png(file = "~/graphics/seurat12-labeledUMAP.png")
...
png(file = "~/graphics/seurat12-dotplot.png")
...
p9 <- ggplot(avg.ilcs, aes(healthy, UC)) + geom_point() + ggtitle("ILCs")
p9 <- LabelPoints(plot = p9, points = genes.to.label, repel = TRUE)
png(file = "~/graphics/seurat12-diffgenes.png")
p9
dev.off()
